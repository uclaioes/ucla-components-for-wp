...
3. Search for `UCLA Components for WordPress` and click 'Install Now' or click on the `upload` link to upload `ucla-components-for-wp.zip`
4. Click on `Activate plugin`

== Changelog ==

= 1.0.0: October 13, 2021 =
* Birthday of UCLA Components for WordPress