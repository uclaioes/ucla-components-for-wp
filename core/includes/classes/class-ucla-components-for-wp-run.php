...
/**
 * Class Ucla_Components_For_Wp_Run
 *
 * Thats where we bring the plugin to life
 *
 * @package		UCLACOMPONENTSWP
 * @subpackage	Classes/Ucla_Components_For_Wp_Run
 * @author		Scott Gruber
 * @since		1.0.0
 */
class Ucla_Components_For_Wp_Run{
	...
	/**
	 * Our Ucla_Components_For_Wp_Run constructor 
	...
	*/
	public function add_plugin_action_link( $links ) {
		...
		$links['our_shop'] = sprintf( '<a href="%s" title="Custom Link" style="font-weight:700;">%s</a>', 'https://test.test', __( 'Custom Link', 'ucla-components-for-wp' ) );
	...
	/**
	 * Enqueue the public related scripts and styles for this plugin.
	 * All of the added scripts andstyles will be available on every page within the backend.
	 *
	 * @access	public
	 * @since	1.0.0
